...
const DATA = {
  ...
  places: {
    ...
    habib:     { name:"Masjid Habib (Masjid Daerah Timur Laut)", lat:5.4495, lng:100.3082, addr:"5, Jalan Seri Tanjung Pinang, Tanjung Tokong", tagline:"Masjid baru 2026, kubah bentuk intan", special:"Masjid baru, dibuka Januari 2026. Kubah bentuk intan.", tips:"Parking luas." },
    kapitan:   { name:"Masjid Kapitan Keling", lat:5.417, lng:100.3371, addr:"14, Lebuh Buckingham, George Town", tagline:"Masjid warisan 1801 di tengah George Town", special:"Masjid warisan 1801.", tips:"4 minit jalan kaki dari Hameediyah, di laluan ke Armenian Street." },
    ...
    olo:       { name:"OLO Studio", lat:5.395, lng:100.3171, addr:"Level 3, Straits Garden, Jelutong", hours:"11.00 pg – 7.00 mlm", tagline:"Kraf dan tufting, berbumbung", special:"Kraf & tufting, berbumbung.", tips:"5 minit dari homestay." },
    gurney:    { name:"Gurney Plaza", lat:5.438, lng:100.31, addr:"170, Persiaran Gurney", hours:"10.00 pg – 10.00 mlm" }
  },
  ...
  days: [
    {
      ...
      items:[
        ...
        { move:{ km:3, min:6 } },
        { t:'11:45', e:'12:45', type:'meal', title:'Makan tengah hari — Mentari Pagi by Sofea', place:'sofea', flags:[{k:'warn',v:'Tutup 1.00 tgh'}], planB:[{ place:"beratur", why:"Berhawa dingin, buka 9 pg – 11 mlm jadi tiada risiko tutup. 6 minit dari LTAPP." }, { name:"Cargas Café", addr:"Main Road Bayan Lepas", rating:4.3, why:"Nasi campur murah, 2 minit dari LTAPP, tapi panas dan self-service." }, { name:"Bayan Baru Market Food Court", why:"Medan selera MBPP, banyak gerai Muslim, semua orang boleh pilih sendiri. 12 minit." }, { name:"Alunan Rasa by Irama Dining", addr:"Setia Triangle", rating:4.6, why:"Ada surau, tapi buka 12.00 tgh sahaja." }] },
        ...
        { t:'18:40', e:'19:10', type:'stop', title:'PakTeh Fruits — kedai buah viral', place:'pakteh', planB:[{ name:"Jeruk Madu Pak Ali", addr:"Jalan Penang", why:"Kalau tak sempat, buah tangan sama boleh dapat di sini pada Hari 3, 2 minit dari Chowrasta." }] },
    ...
    },
    {
      ...
      items:[
        ...
        { t:'08:00', e:'09:00', type:'meal', title:'Sarapan — Roti Bakar Hutton Lane', place:'hutton', planB:[{ place:"fizzy", why:"Simpan untuk Isnin." }, { name:"Kopitiam 7 Pagi" }, { name:"Hidden Cafe Kg Tepi Pantai" }, { name:"Gemas Road Brothers" }] },
        { move:{ km:6, min:20, via:'Jalan Air Itam' } },
        { t:'09:30', e:'12:00', type:'stop', title:'Penang Hill', place:'hill', planB:[{ name:"Taman Botani Pulau Pinang", why:"Kaki bukit, percuma." }, { name:"The Habitat Penang Hill", why:"Atas bukit, RM50 dewasa." }, { name:"Pantai Miami", addr:"Batu Ferringhi" }, { name:"Tropical Spice Garden", addr:"Teluk Bahang" }, { name:"Entopia Butterfly Farm", addr:"Teluk Bahang" }] },
        { move:{ km:6, min:20, via:'Jalan Air Itam → Jalan Dato Keramat' } },
        { t:'12:25', e:'13:45', type:'meal', title:'Makan tengah hari — Nasi Kandar Hameediyah', place:'hameed', flags:[{k:'info',v:'Zohor 1.17 ptg'}], planB:[{ name:"Kassim Nasi Kandar" }, { name:"Nasi Kandar Kampong Pisang", addr:"Air Itam", why:"Kalau lapar sebelum turun bukit." }] },
        ...
        { t:'16:10', e:'17:15', type:'stop', title:'Chew Jetty', place:'chew', meta:'Petang angin laut, cahaya lembut, kurang terik.', planB:[{ name:"Hin Bus Depot", why:"Seni, kafe." }, { place:"gurney", why:"Kalau hujan petang." }] },
        { move:{ km:4, min:12 } },
        ...
        { t:'20:00', e:'22:00', type:'meal', title:'Makan malam bersama Umi Wan', meta:'Lokasi: akan dimaklumkan.', planB:[{ name:"Premium Chinese Muslim Cuisine" }, { name:"Tok Ma Malay Kitchen", addr:"George Town" }, { name:"The Table Penang" }, { name:"Rumah Kacha" }, { name:"Jawi House Cafe Gallery" }] },
    ...
    },
    {
      ...
      items:[
        ...
        { move:{ km:4, min:12 } },
        { t:'08:45', e:'09:55', type:'meal', title:'Sarapan — Makan Pagi by Fizzy', place:'fizzy', meta:'Parking di Chowrasta (bertingkat), 3 minit jalan kaki.', planB:[{ name:"Kopitiam 7 Pagi" }, { name:"Hidden Cafe Kg Tepi Pantai" }, { name:"Gemas Road Brothers" }] },
